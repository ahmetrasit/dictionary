...
count, Arabic text, source names and references, reviewed name forms,
transliterations, morphology, attachments, occurrences, and provenance.
...
contextual gloss separation; no invented proper-name spelling; and relation
labels consistent with boundary/asymmetry fields.
